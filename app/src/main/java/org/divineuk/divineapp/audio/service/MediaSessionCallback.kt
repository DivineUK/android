...
class MediaSessionCallback(
    ...
    private fun checkAndStartPlaying(songs: ArrayList<NetworkAudio>, itemId: Long) {
    ...
    private fun openQueue(songs: ArrayList<NetworkAudio>, index: Int, startPlaying: Boolean = true) {
