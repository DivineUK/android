...
import org.divineuk.divineapp.DivineApplication;
...
public class RetroUtil {
  ...
  public static int getStatusBarHeight() {
    int result = 0;
    int resourceId =
        DivineApplication.Companion.getContext()
            .getResources()
            .getIdentifier("status_bar_height", "dimen", "android");
    if (resourceId > 0) {
      result = DivineApplication.Companion.getContext().getResources().getDimensionPixelSize(resourceId);
    }
    return result;
  }
  ...
  public static boolean isLandscape() {
    return DivineApplication.Companion.getContext().getResources().getConfiguration().orientation
